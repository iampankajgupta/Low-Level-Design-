...
public abstract class ElevatorAssignmentStrategy {

    public abstract Elevator assignElevator(List<Elevator> elevatorList, OutsideRequest outsideRequest);

    public Elevator findBestElevator(List<Elevator> elevatorList, OutsideRequest outsideRequest) {
